...
Multiple Dithering Patterns – Includes Bayer matrix, blue noise, Obra Dinn-style, and other classic dithering algorithms
...
Assign the dithering shader to your camera's post-processing effect

Adjust the two target colors and select your preferred dithering pattern

Tweak parameters to match your desired visual style

Requirements
Unity (version compatible with your setup)
